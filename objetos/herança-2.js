...
Object.prototype.atri0 = 'd'//noa é um apratica recomendada evite fazer isso <<!!atençao!!>>
...
const filho = {
    __proto__: pai,//O mesmo fizemos nesta linha atribuitmos o "__proto__ do (filo) sendo o (pai) par que caso nao encontre aqui o atributo em questão seja feito a varredura no "pai" e se não enconstrar no "pai" ele vai buscar no "avo" 
    atri3: 'c'
}
//lembrando que a "const" (avo) tem como (__proto__) o object.prototype.

//Agora vamos fazer um teste onde vamos mandar mostrar na tela o "atri1" do "filho" mas como o "filho não possui este (atri1) o sistema vai procurar no __proto__ do filho que é o (pai) e como tambem ele nao vai enconstrar o atri1 no pai ele vai buscara no __proto__ do pai que é o avo e assim ele vai encontrar respeitando de fato a hierarquia do __proto_ que estabelecemos "
