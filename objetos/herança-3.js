...
//E neste caso ja posso alterar o nome da filha dinamicamente.
filha1.nome = "Ana"
...
//O mesmo vamos fazer com filha2
...
for (let key in filha2) {//ond está o parametro (key) pode ser trocado por qualquer outro pois ele é um avariavel de escopo de repetição usada somente para enconstrar os atributos de filha
    console.log(key)
}
//mas vamos fazer um teste para saber se o atributo pertence de fato a ela e para isso vamos usar o (hasOwnProperty()) e vamos usar tambem um operador ternario  ? : que funciona como uma estrutura condicional
